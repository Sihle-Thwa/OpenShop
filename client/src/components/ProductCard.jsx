...
function ProductCard({ product }) {
  ...
  role="button"
  tabIndex="0"
  className={`col-2 p-1 rounded-circle d-flex justify-content-center align-items-center ${isSelected ? '' : ''}`}
  onClick={handleClick}
...
{isSelected ? <BsHeartFill color="red" /> : <BsHeart color="black" />}
      ...
      >
        <div className="toast-header justify-content-between">
          ...
          <button type="button" className="ml-2 mb-1 close" onClick={handleToastClose}>
            <span>&times;</span>
          </button>
        </div>
